    ...
    a.fn.counterUp = function(b) {
        ...
        return this.each(function() {
            ...
            b.waypoint(function() {
                var a = [],
                    c = d.time / d.delay;
                b.data("text") == null ? b.data("text", b.text()) : b.text(b.data("text"));
                var e = b.text(),
                    f = /[0-9]+,[0-9]+/.test(e);
                e = e.replace(/,/g, "");
                for (var g, h = /^[0-9]+$/.test(e), j = /^[0-9]+\.[0-9]+$/.test(e), k = j ? (e.split(".")[1] || []).length : 0, l = c; 1 <= l; l--) {
                    if (g = parseInt(e / c * l), j && (g = parseFloat(e / c * l).toFixed(k)), f)
                        for (;
                            /(\d+)(\d{3})/.test(g.toString());) g = g.toString().replace(/(\d+)(\d{3})/, "$1,$2");
                    a.unshift(g)
                }
                b.data("counterup-nums", a), b.text("0");
                b.data("counterup-func", function() {
